...
EXTRA_ARGS="offline_router.train.supervision_mode=text_reward_vector offline_router.train.mode=full_backbone offline_router.train.train_sampling_strategy=pairwise_sign_balanced_oversample offline_router.train.max_train_rows=4096 offline_router.train.max_eval_rows=178 offline_router.train.max_seq_length=32000 offline_router.train.num_epochs=1 offline_router.train.save_checkpoints=false offline_router.train.text_reward.debug_step_logging=false"
