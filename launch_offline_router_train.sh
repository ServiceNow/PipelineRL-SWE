...
TIMESTAMP=$(date +%s)
JOB_NAME=offline_router_train_text_mode_full
...
EXTRA_ARGS="offline_router.train.supervision_mode=text_reward_per_route offline_router.train.mode=full_backbone offline_router.train.save_checkpoints=true" \
