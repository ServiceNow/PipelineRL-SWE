...
TIMESTAMP=$(date +%s)
JOB_NAME=offline_router_stage_2_dsp_full_with_save
...
EXTRA_ARGS="offline_router.train.supervision_mode=representation_head offline_router.train.mode=full_backbone offline_router.train.max_train_rows=4096 offline_router.train.max_eval_rows=178 offline_router.train.num_epochs=2" \
