...
COLLECTOR_ENV=pipeline-rl

PRIMARY_MODEL_PATH=/mnt/llmd/results/exps/aristides/reason/swe_smith_policy_conditioned_no_devstral_1773812579/finetune/current
PRIMARY_TOKENIZER_NAME=Qwen/Qwen2.5-Coder-7B-Instruct
PRIMARY_SERVED_MODEL_NAME=primary_model
