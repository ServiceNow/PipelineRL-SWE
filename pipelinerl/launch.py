...
def run_actor_llm(
    ...
    master_addr = os.environ.get("MASTER_ADDR", world_map.master_addr)
    cmd = [
        "python",
        "-m",
        entrypoint,
...
def run_finetune(cfg: DictConfig, world_map: WorldMap, gpus: list[int], exp_dir: Path):
    ...
    cmd += [
        ...
        f"+me.weight_update_group_init_method=tcp://{os.environ.get('MASTER_ADDR', world_map.master_addr)}:{cfg.world.actor_group_port}",
