...
class PipelineBatchEncoding(BaseModel):
    ...
    performance_targets: torch.FloatTensor
    ...
    @field_validator('rewards', 'performance_targets', 'advantages', 'ref_logprobs', 'old_logprobs', 'group_tokens', 'num_labels', 'overflow', 'pixel_values', mode='before')
    @classmethod
